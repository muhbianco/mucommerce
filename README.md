...
- Host da plataforma: `loja.muhbianco.com.br` = tenant `muhbianco`, a loja modelo (sem staging; ver ADR 0007). `make api-migrate` + `python -m app.cli tenant seed-platform`.
