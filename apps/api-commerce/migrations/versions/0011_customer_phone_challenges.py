...
def downgrade() -> None:
    op.drop_index("ix_customer_phone_challenges_tenant_id", table_name="customer_phone_challenges")
    op.drop_index("ix_customer_phone_challenges_customer", table_name="customer_phone_challenges")
